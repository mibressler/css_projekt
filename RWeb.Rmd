...
```{r, fig.height=3}
p <- dygraph(SchlesHols_XT)
for (i in 1:length(schleshols_ae)) {
  p <- p %>% dyEvent(schleshols_ae[i], label = "*", labelLoc = "bottom")
}
p

dygraph(SchlesHols_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-03-17","SARS-CoV-2-BekämpfungsVO vom 17.März", labelLoc = "bottom") %>%
...
schleshols_ae <- as.character(geltung_ae_schleshols)
  
# for (i in length(schleshols_ae)) {
#  date <- schleshols_ae[i]
 # dyEvent(date,"*", labelLoc="bottom")
#}
...
```{r, fig.height=3}
dygraph(Hamb_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-03-16","Allgemeinverfügung", labelLoc = "bottom") %>% dyEvent("2020-04-03","HmbSARS-CoV-2-EindämmungsVO vom 2.April", labelLoc = "bottom") %>% 
...
```{r, fig.height=3}
dygraph(NordWest_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange")  %>% dyEvent("2020-03-23","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-04-20","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-04","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-07","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-11","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-20","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-21","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-05-30","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-06-15","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-06-16","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-06-25","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-06-30","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-07-01","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-07-15","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-08-12","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-08-14","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-09-01","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-09-15","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-10-01","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-10-17","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-11-02","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-11-10","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-12-01","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-12-09","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-12-16","CoronaSchVO", labelLoc = "bottom") %>% dyEvent("2020-12-18","CoronaSchVO", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(RhePfalz_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange")%>% dyEvent("2020-03-20","1. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-03-21","2. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-03-23","3. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-04-20","4. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-05-03","5. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-05-13","6. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-05-18","7. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-05-27","8. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-06-10","9. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-06-24","10. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-09-16","11. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-11-02","12. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-12-01","13. CoBeLVO", labelLoc = "bottom") %>% dyEvent("2020-12-16","14. CoBeLVO", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Hessen_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(BadWuert_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Bay_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% 
...
```{r, fig.height=3}
dygraph(Saarl_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>%
  dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Berlin_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Brand_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(MeckVor_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Sachsen_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-04-01","SächsCoronaSchVO vom 31.März", labelLoc = "bottom") %>%
...
```{r, fig.height=3}
dygraph(SachAnh_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-12-16","11. BayIfSMV", labelLoc = "bottom")
...
```{r, fig.height=3}
dygraph(Thuer_XT, main = "Infektionsfälle über Zeit", ylab = "Gemeldete Infektionsfälle") %>% dyOptions(colors="orange") %>% dyEvent("2020-03-25","Corona EindämmungsVO", labelLoc = "bottom") %>%
